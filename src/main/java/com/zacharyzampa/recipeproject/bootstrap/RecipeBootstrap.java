package com.zacharyzampa.recipeproject.bootstrap;

import com.zacharyzampa.recipeproject.domain.*;
import com.zacharyzampa.recipeproject.domain.repositories.CategoryRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    @Override
    @Transactional  // everything within will now happen in the same transaction context and the lazy initalization exception error will not occur
    ...
    private List<Recipe> getRecipes() {
        ...
        guacRecipe.setDifficulty(DifficultyEnum.EASY);
        ...
        tacosRecipe.setDifficulty(DifficultyEnum.MODERATE);
